...
def parse_args():
    ...
    parser.add_argument("--checkpoint_path", type=str, required=True, help="Path to converted PyTorch model checkpoint (model.safetensors). Required — never uses random init.")
